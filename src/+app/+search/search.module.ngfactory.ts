...
import * as import7 from './search-routing.module';
...
import * as import12 from './search.component.ngfactory';
import * as import13 from '@angular/core/src/i18n/tokens';
import * as import14 from './search.component';
...
class SearchModuleInjector extends import0.NgModuleInjector<import1.SearchModule> {
  ...
  _SearchRoutingModule_6:import7.SearchRoutingModule;
  _SearchModule_7:import1.SearchModule;
  ...
  constructor(parent:import11.Injector) {
    super(parent,[import12.SearchComponentNgFactory],([] as any[]));
  }
  ...
  get _ROUTES_11():any[] {
        if ((this.__ROUTES_11 == (null as any))) { (this.__ROUTES_11 = [[{
          path: 'search',
          component: import14.SearchComponent
        }
    ]]); }
  ...
  createInternal():import1.SearchModule {
    ...
    this._SearchRoutingModule_6 = new import7.SearchRoutingModule();
    this._SearchModule_7 = new import1.SearchModule();
    return this._SearchModule_7;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import7.SearchRoutingModule)) { return this._SearchRoutingModule_6; }
    if ((token === import1.SearchModule)) { return this._SearchModule_7; }
