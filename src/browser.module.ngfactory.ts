...
import * as import52 from './+app/app.component.ngfactory';
...
import * as import61 from 'angular2-universal/browser/env';
...
class MainModuleInjector extends import0.NgModuleInjector<import1.MainModule> {
  ...
  get _EventManager_38():import28.EventManager {
    if ((this.__EventManager_38 == (null as any))) { (this.__EventManager_38 = new import28.EventManager(this._EVENT_MANAGER_PLUGINS_37,this.parent.get(import55.NgZone))); }
  ...
  get _RootRenderer_41():any {
    if ((this.__RootRenderer_41 == (null as any))) { (this.__RootRenderer_41 = import56._createConditionalRootRenderer(this._DomRootRenderer_40,this.parent.get(import56.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_62():any {
    if ((this.__LocationStrategy_62 == (null as any))) { (this.__LocationStrategy_62 = import10.provideLocationStrategy(this.parent.get(import57.PlatformLocation),this.parent.get(import58.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_61)); }
  ...
  get _REQUEST_IDLE_CALLBACK_67():any {
    if ((this.__REQUEST_IDLE_CALLBACK_67 == (null as any))) { (this.__REQUEST_IDLE_CALLBACK_67 = import11._requestIdle(this.parent.get(import55.NgZone))); }
    return this.__REQUEST_IDLE_CALLBACK_67;
  }
  get _IdlePreload_68():import11.IdlePreload {
    if ((this.__IdlePreload_68 == (null as any))) { (this.__IdlePreload_68 = new import11.IdlePreload(this.parent.get(import55.NgZone),this._REQUEST_IDLE_CALLBACK_67)); }
  ...
  get _isNode_80():any {
    if ((this.__isNode_80 == (null as any))) { (this.__isNode_80 = import61.isNode); }
  ...
  createInternal():import1.MainModule {
    ...
    this._ROUTER_FORROOT_GUARD_11 = import10.provideForRootGuard(this.parent.get(import62.Router,(null as any)));
    ...
    this._Testability_31 = new import24.Testability(this.parent.get(import55.NgZone));
    this._ApplicationRef__32 = new import25.ApplicationRef_(this.parent.get(import55.NgZone),this.parent.get(import63.Console),this,this._ErrorHandler_29,this,this._ApplicationInitStatus_30,this.parent.get(import24.TestabilityRegistry,(null as any)),this._Testability_31);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import64.DOCUMENT)) { return this._DOCUMENT_5; }
    ...
    if ((token === import65.LOCALE_ID)) { return this._LOCALE_ID_27; }
    if ((token === import22.NgLocalization)) { return this._NgLocalization_28; }
    if ((token === import66.ErrorHandler)) { return this._ErrorHandler_29; }
    ...
    if ((token === import68.AnimationDriver)) { return this._AnimationDriver_39; }
    if ((token === import29.DomRootRenderer)) { return this._DomRootRenderer_40; }
    if ((token === import69.RootRenderer)) { return this._RootRenderer_41; }
    if ((token === import30.DomSanitizer)) { return this._DomSanitizer_42; }
    if ((token === import70.Sanitizer)) { return this._Sanitizer_43; }
    if ((token === import31.ViewUtils)) { return this._ViewUtils_44; }
    if ((token === import71.IterableDiffers)) { return this._IterableDiffers_45; }
    if ((token === import72.KeyValueDiffers)) { return this._KeyValueDiffers_46; }
    ...
    if ((token === import58.LocationStrategy)) { return this._LocationStrategy_62; }
    if ((token === import41.Location)) { return this._Location_63; }
    if ((token === import75.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_64; }
    if ((token === import76.ROUTES)) { return this._ROUTES_65; }
    if ((token === import62.Router)) { return this._Router_66; }
    ...
    if ((token === import67.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_71; }
    ...
    if ((token === import77.ActivatedRoute)) { return this._ActivatedRoute_74; }
